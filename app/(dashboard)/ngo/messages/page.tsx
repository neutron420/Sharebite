...
function MessagesContent() {
 ...
 if (loading) {
 return (
 <div className="flex h-[calc(100vh-8rem)] items-center justify-center p-20 bg-white ">
 ...
 onBack={() => router.push("/ngo/messages")}
 />
 ) : (
 ...
 <div>
 <h2 className="text-3xl font-black tracking-tighter text-slate-950 uppercase mb-4">NGO Comms Hub</h2>
