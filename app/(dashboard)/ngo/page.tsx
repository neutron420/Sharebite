...
export default function NgoDashboard() {
 ...
 className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-white/10 hover:bg-orange-600 transition-all flex items-center justify-center border border-white/20 group/msg"
 >
 ...
 <div>
 <h2 className="text-xl sm:text-3xl font-black tracking-tighter uppercase text-slate-950">Supply Audit Feed</h2>
 ...
 <Soup className="w-5 h-5 sm:w-6 sm:h-6 text-slate-400 group-hover:text-orange-600" />
 )}
 </div>
 <div className="min-w-0">
 ...
 <Link href="/ngo/find-food" className="mt-8 px-10 py-5 bg-orange-600 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-slate-950 transition-all shadow-xl shadow-orange-100 ">
 Explore Global Hub
 </Link>
 </div>
 )}
 ...
 <h3 className="text-xl sm:text-2xl font-black mb-4 tracking-tighter text-slate-950 leading-tight">Verified <br />Distributor Hub</h3>
