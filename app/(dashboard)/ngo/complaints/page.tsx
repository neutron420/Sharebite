...
export default function NgoComplaintsPage() {
  ...
  return (
    <div className="w-full py-6 sm:py-10 space-y-8 italic">
      {/* Header */}
      ...
      {loading ? (
        ...
        <div className="p-12 sm:p-20 rounded-3xl sm:rounded-[3rem] border-2 border-dashed border-slate-100 flex flex-col items-center text-center">
          ...
          <h4 className="font-black text-xl text-slate-950 uppercase italic tracking-tighter">No alerts found</h4>
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-5 sm:gap-6">
                  <div className="flex items-start gap-4 flex-1 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h4 className="font-black text-lg sm:text-xl tracking-tighter uppercase italic group-hover:text-orange-600 transition-colors truncate">Against: {report.donor.name}</h4>
                      ...
                      <div className="mt-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 space-y-3">
                        <div>
                           ...
                           <p className="text-sm font-bold text-slate-950 italic">{report.reason}</p>
                        </div>
                        {report.details && (
          ...
          >
            ...
            >
              ...
              <div className="mb-6 sm:mb-8 pr-12">
                <h2 className="text-2xl sm:text-3xl font-black tracking-tight uppercase italic underline decoration-orange-600/20 underline-offset-8">Mission Report</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-2.5">
                  ...
                  {selectedDonor ? (
                    <div className="flex items-center justify-between p-4 bg-orange-50 border border-orange-100 rounded-xl sm:rounded-2xl">
                      <div>
                        <p className="font-black text-sm text-slate-950 uppercase italic tracking-tight">{selectedDonor.name}</p>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-xl sm:rounded-2xl text-[11px] font-black uppercase tracking-widest focus:outline-none focus:border-orange-500 transition-all placeholder:italic placeholder:font-bold placeholder:text-slate-200"
                      />
                      ...
                      {donorResults.length > 0 && (
                        <div className="absolute z-10 mt-2 w-full bg-white border border-slate-100 rounded-2xl shadow-2xl max-h-48 overflow-y-auto">
                          {donorResults.map((donor) => (
                            ...
                            >
                              <p className="font-black text-xs uppercase italic">{donor.name}</p>
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="relative">
                     <select
                        ...
                        required
                        className="w-full py-4 px-5 bg-slate-50 border border-slate-100 rounded-xl sm:rounded-2xl text-[11px] font-black uppercase tracking-widest focus:outline-none focus:border-orange-500 transition-all appearance-none cursor-pointer italic"
                     >
                ...
                <div className="space-y-2.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-4 bg-slate-50 border border-slate-100 rounded-xl sm:rounded-2xl text-[11px] font-black tracking-wider focus:outline-none focus:border-orange-500 transition-all resize-none placeholder:italic placeholder:font-bold placeholder:text-slate-200"
                  />
                </div>
