...
export default function NgoHistoryPage() {
 ...
 <h3 className="text-xl sm:text-2xl font-black text-slate-950 ">{totalRescued} <span className="text-[10px] sm:text-xs uppercase opacity-40">kg</span></h3>
 </div>
 ...
 <h3 className="text-xl sm:text-2xl font-black text-slate-950 ">{history.length} <span className="text-[10px] sm:text-xs uppercase opacity-40">Ops</span></h3>
 </div>
 </div>
 </header>
 ...
 className="w-full py-4 sm:py-5 pl-12 pr-6 bg-white border border-slate-100 rounded-2xl sm:rounded-[2rem] shadow-xl shadow-slate-200/20 font-bold text-sm outline-none focus:border-orange-200 transition-all placeholder: placeholder:font-bold placeholder:text-slate-300"
 />
 </section>
 ...
 <h4 className="font-black text-base sm:text-xl tracking-tight text-slate-950 group-hover:text-orange-600 transition-colors uppercase truncate">{item.donation.title}</h4>
 ...
 <div className="py-20 sm:py-40 text-center space-y-4 rounded-3xl sm:rounded-[4rem] border-2 border-dashed border-slate-100 ">
 ...
 <h3 className="text-xl sm:text-2xl font-black text-slate-950 uppercase tracking-tighter">Archive Empty</h3>
