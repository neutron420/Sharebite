...
export default function NGOProfilePage() {
  ...
  return (
    <div className="w-full space-y-6 sm:space-y-8 pb-12 italic">
      {/* Cover/Header area */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-slate-950 rounded-3xl p-6 sm:p-8 text-white shadow-xl shadow-slate-200">
             ...
             <div className="flex items-center justify-between bg-white/5 p-4 rounded-xl border border-white/10 italic">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm italic">
  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-slate-100/50 transition-all group">
      ...
      <div className="flex items-baseline gap-2">
        <span className="text-xl sm:text-3xl font-black text-slate-900 tracking-tighter uppercase italic">{value}</span>
      </div>
