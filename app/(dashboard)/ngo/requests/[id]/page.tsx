...
export default function RequestDetailPage() {
 ...
 <h1 className="text-2xl sm:text-4xl font-black tracking-tight uppercase text-slate-950 truncate">Mission Manifest</h1>
 ...
 <div className="w-full h-full flex items-center justify-center text-5xl sm:text-6xl grayscale opacity-40 ">🥪</div>
 )}
 </div>
 ...
 <h2 className="text-3xl sm:text-5xl font-black tracking-tighter text-slate-950 uppercase leading-none">{request.donation.title}</h2>
 </div>
 ...
 <h3 className="text-[10px] sm:text-sm font-black flex items-center gap-3 text-slate-950 uppercase tracking-widest underline decoration-orange-600/10 underline-offset-4 px-2">
 ...
 <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tight">Payout Control Center</h3>
 
 {request.step === 3.4 && request.deliveryPin && (
 <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 w-full max-w-sm space-y-4">
 <p className="text-[10px] font-black uppercase tracking-widest text-orange-500">NGO Delivery PIN</p>
 <div className="text-5xl sm:text-6xl font-black tracking-[0.5em] text-white ">{request.deliveryPin}</div>
 <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Share this with the rider to verify takeover.</p>
 </div>
 )}
 ...
 : "Donation is completed. Share the NGO PIN shown above with the rider. Once they verify it, payout release will unlock."}
 </p>
 {isReadyToReleasePayout ? (
 ...
 <h3 className="text-2xl sm:text-4xl font-black uppercase tracking-tight">Mission Accomplished</h3>
 ...
 <p className="text-base sm:text-lg font-black text-slate-950 leading-tight uppercase ">Direct channel access</p>
 </div>
 ...
 <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600 font-black text-sm uppercase ">D</div>
 ...
 <button className="flex items-center justify-between p-4 sm:p-6 bg-white rounded-2xl border border-slate-100 group hover:border-orange-200 transition-all shadow-sm">
 <div className="flex items-center gap-4">
 <div className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-950 rounded-xl flex items-center justify-center text-white font-black text-sm uppercase ">R</div>
 <div className="text-left">
 <p className="text-[9px] font-black text-slate-300 uppercase tracking-widest leading-none mb-1">Protocol</p>
 ...
 <p className="text-base sm:text-lg font-black text-slate-950 leading-tight uppercase ">Awaiting Donor PIN Auth</p>
 </div>
 ...
 maxLength={4} 
 placeholder="----"
 className="w-full text-center py-5 bg-slate-50 rounded-xl border-2 border-slate-100 focus:border-orange-500 focus:bg-white text-3xl font-black tracking-[0.4em] transition-all outline-none "
 value={pin}
