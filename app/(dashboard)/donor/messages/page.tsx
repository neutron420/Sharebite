...
function MessagesContent() {
 ...
 if (loading) {
 return (
 <div className="flex h-[calc(100vh-8rem)] items-center justify-center p-6 sm:p-20 bg-white ">
 ...
 onSelect={(id) => router.push(`/donor/messages?id=${id}`)}
 />
 </div>
 ...
 <div>
 <h2 className="text-3xl font-black tracking-tighter text-slate-950 uppercase mb-4">Command Center</h2>
