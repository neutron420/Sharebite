      ...
      <main className="relative z-10 w-full pt-56 pb-32">
        ...
        <section className="px-6 flex flex-col items-center text-center max-w-5xl mx-auto">
          <motion.div
            ...
            className="px-5 py-2 rounded-full border border-orange-100 bg-orange-50 text-[11px] font-black uppercase tracking-[0.25em] text-orange-600 mb-10 inline-flex items-center gap-3"
          >
          ...
          >
            <Link href="/register" className="px-12 py-5 bg-orange-600 text-white font-black text-lg rounded-[1.5rem] hover:bg-orange-700 hover:shadow-2xl hover:shadow-orange-100 transition-all active:scale-95 flex items-center gap-3">
              Start Donating <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="#features" className="px-12 py-5 bg-white border border-slate-200 text-slate-950 font-black text-lg rounded-[1.5rem] hover:bg-slate-50 transition-all active:scale-95 flex items-center gap-3">
          ...
          <div className="mt-32 w-full max-w-6xl">
            <p className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-300 mb-12">Trusted Power Partners</p>
