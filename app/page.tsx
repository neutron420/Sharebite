    ...
    <div className="relative min-h-screen bg-white text-slate-950 flex flex-col items-center selection:bg-orange-100 overflow-hidden">
      ...
      <nav className="fixed top-8 z-50 w-[95%] max-w-7xl">
        <div className="mx-auto rounded-[2rem] border border-orange-100 bg-white/60 backdrop-blur-2xl px-8 py-4 flex items-center justify-between shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
          ...
          <div className="hidden lg:flex items-center gap-12 text-[12px] font uppercase tracking-[0.2em] text-slate-400">
      ...
      <main className="relative z-10 w-full pt-56 pb-32">
        ...
        <section className="px-6 flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-[80px] font tracking-tight leading-[0.95] mb-10 text-slate-950"
          >
            Zero Waste. <br />
          ...
          >
            <Link href="/register" className="px-12 py-5 bg-orange-600 text-white font text-lg rounded-[1.5rem] hover:bg-orange-700 hover:shadow-2xl hover:shadow-orange-100 transition-all active:scale-95 flex items-center gap-3">
              Start Donating <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="#features" className="px-12 py-5 bg-white border border-slate-200 text-slate-950 font text-lg rounded-[1.5rem] hover:bg-slate-50 transition-all active:scale-95 flex items-center gap-3">
              ...
              <Marquee pauseOnHover className="[--duration:25s] py-12">
                {partners.map((p, i) => (
                  <div key={i} className="flex items-center gap-6 mx-12 grayscale opacity-30 hover:grayscale-0 hover:opacity-100 transition-all cursor-default group">
                     ...
                     <span className="text-2xl font  tracking-tighter text-slate-900">{p.name}</span>
                  </div>
                ))}
              </Marquee>
            </div>
        ...
        <section className="px-6 py-48 text-center">
          <h2 className="text-5xl md:text-[100px] font tracking-tighter mb-14 text-slate-950 ">Ready to Lead?</h2>
          ...
          <Link href="/register" className="px-20 py-8 bg-slate-950 text-white font text-2xl rounded-[2rem] hover:bg-orange-600 hover:-translate-y-2 transition-all shadow-[0_20px_50px_rgba(0,0,0,0.1)] active:scale-95 group">
