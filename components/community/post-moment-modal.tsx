      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center sm:p-4 p-0">
          ...
          <motion.div
            ...
            className="relative w-full sm:max-w-xl h-full sm:h-auto sm:max-h-[90vh] bg-white sm:rounded-3xl rounded-none shadow-2xl overflow-hidden overflow-y-auto"
          >
            <div className="p-4 sm:p-6 border-b border-slate-100 flex items-center justify-between sticky top-0 bg-white z-10 font-black italic">
              <div className="flex items-center gap-2">
                <Sparkles className="text-orange-500 w-5 h-5" />
                <h2 className="text-lg sm:text-xl font-bold text-slate-800 uppercase tracking-tighter">Share a Moment</h2>
              </div>
