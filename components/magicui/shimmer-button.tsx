...
export default function ShimmerButton({
  ...
  return (
    ...
    >
      ...
      >
        {/* spark */}
        <div className="absolute inset-0 h-[100cqh] animate-shimmer-slide [aspect-ratio:1] rounded-none [mask:none]">
          {/* spark before */}
      ...
      <span className="z-10 whitespace-pre bg-linear-to-b from-white/30 from-[28%] bg-clip-text font-semibold leading-none tracking-tight text-white">
        {children}
      </span>
    </button>
  );
