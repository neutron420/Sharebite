  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-[11rem] right-6 z-50 h-10 w-10 sm:h-12 sm:w-12 sm:bottom-[88px] rounded-full bg-slate-950 text-white shadow-xl flex items-center justify-center border-2 border-white transition-all hover:bg-red-500 group"
      >
